...
(\cref{app:dropped}). One trial per cell at temperature~\temperature{}, a \maxOutputTokens{}-token output
...
re-reads those responses. The cap was raised from an initially planned \plannedOutputTokens{} tokens
