...
and \geminiExfil{}/\geminiN{} across \pooledEpisodes{} episodes; we decline to
read that gap as a claim about deployment category, because the design confounds
license with model tier.
\else
