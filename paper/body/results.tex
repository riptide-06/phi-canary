...
\corpusSize{}-payload corpus. Error bars are percentile bootstrap 95\% intervals
over \bootN{} resamples of the payload corpus at seed \bootSeed{}; one run per
cell at temperature~0, so they quantify variability across payloads and not
...
\toprule
Model & Category & Injected exfil. & 95\% CI & Control exfil. & Control, any egress \\
\midrule
...
host on \llamaExfil{} of \llamaN{} payloads (95\% CI [\llamaCIlo{},
...
scale---a small ``lite'' tier against a 70B model---so license and capability are
...
open-weights model is 70B---so license and capability are perfectly confounded
