...
The result worth carrying forward required admitting a design error: the obvious
form of this label was wrong \llamaControlFPRate{} of the time on traffic that
contained no adversary at all.
\else
